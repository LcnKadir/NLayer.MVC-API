...
namespace NLayer.Web.Services
{
    public class ProductApiService
    {
        ...
        public async Task<List<ProductWtihCategoryDto>> GetProductsWithCategoryAsync()
        {
            var response = await _httpClient.GetFromJsonAsync<CustomResponseDto<List<ProductWtihCategoryDto>>>("Products/GetProductWtihCategory");
